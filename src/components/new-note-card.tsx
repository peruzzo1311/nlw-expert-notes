    ...
    <Dialog.Root>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className='fixed inset-0 md:inset-auto md:left-1/2 md:top-1/2 md:-translate-x-1/2 md:-translate-y-1/2 md:max-w-[640px] w-full md:h-[60vh] bg-slate-700 md:rounded-md flex flex-col outline-none overflow-hidden'>
          <Dialog.Close>
            <X className='size-6 text-slate-300 absolute top-4 right-4' />
          </Dialog.Close>
          ...
          <form className='flex-1 flex flex-col'>
            ...
            {isRecording && (
              <button
                type='button'
                className='w-full flex items-center justify-center gap-2 bg-slate-900 py-4 text-center text-sm text-slate-300 outline-none font-medium hover:bg-text-slate-100'
            ...
            {!isRecording && (
              <button
                ...
                className={
                  ...
                  (content === '' ? ' opacity-50 hover:bg-lime-400 cursor-default' : '')
                }
